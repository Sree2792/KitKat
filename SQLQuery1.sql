...
-- --------------------------------------------------
-- Date Created: 08/29/2018 18:30:25
-- Generated from EDMX file: C:\Users\sjay0010\source\repos\FitnessBourne\FitnessBourne\Models\FitnessBournDBModel.edmx
-- --------------------------------------------------
...
-- Creating table 'EventEditLocationTable'
CREATE TABLE [dbo].[EventEditLocationTable] (
...
-- Creating primary key on [EventEdits_EE_Id], [LocationTables_Loc_Id] in table 'EventEditLocationTable'
ALTER TABLE [dbo].[EventEditLocationTable]
ADD CONSTRAINT [PK_EventEditLocationTable]
    PRIMARY KEY CLUSTERED ([EventEdits_EE_Id], [LocationTables_Loc_Id] ASC);
GO
...
ALTER TABLE [dbo].[EventTables]
ADD CONSTRAINT [FK_EventTableAdmin]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_EventTableAdmin'
CREATE INDEX [IX_FK_EventTableAdmin]
ON [dbo].[EventTables]
    ([EventAdmin_Mem_Id]);
GO
...
-- Creating foreign key on [EventEdits_EE_Id] in table 'EventEditLocationTable'
ALTER TABLE [dbo].[EventEditLocationTable]
ADD CONSTRAINT [FK_EventEditLocationTable_EventEdit]
...
-- Creating foreign key on [LocationTables_Loc_Id] in table 'EventEditLocationTable'
ALTER TABLE [dbo].[EventEditLocationTable]
ADD CONSTRAINT [FK_EventEditLocationTable_LocationTable]
    FOREIGN KEY ([LocationTables_Loc_Id])
    REFERENCES [dbo].[LocationTables]
        ([Loc_Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_EventEditLocationTable_LocationTable'
CREATE INDEX [IX_FK_EventEditLocationTable_LocationTable]
ON [dbo].[EventEditLocationTable]
    ([LocationTables_Loc_Id]);
GO
...
ALTER TABLE [dbo].[NotificationActionTables]
ADD CONSTRAINT [FK_NotificationActionTableNotificationTable]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_NotificationActionTableNotificationTable'
CREATE INDEX [IX_FK_NotificationActionTableNotificationTable]
